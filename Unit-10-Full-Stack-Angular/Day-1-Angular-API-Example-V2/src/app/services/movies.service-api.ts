...
import { lastValueFrom, Observable } from 'rxjs'; // Import lastValueFrom
...
export class MoviesService {
  ...
  // An HttpClient object is automatically created and passed to the constructor (Dependencu Injection)
  ...
  async  getMoviesList() :  Promise<any[]> {  // this function returns a array of objects
      ...
      // Call the API to retreive all the data in the data source
  ...
  async updateMovie(aMovie : MoviesInfo) {
      ...
      //console.table(aMovie)               //o ptional for debugging
      ...
      //                           use http.put(API-URL                        , data-to-send, {header-object})                               
