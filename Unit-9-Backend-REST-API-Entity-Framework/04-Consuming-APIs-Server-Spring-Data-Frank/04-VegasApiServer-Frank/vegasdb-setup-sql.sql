...
-- ---------------------------------------------------------------------------
-- The use statement is required by SQL Server to Tell SQL Server 
--         we want all processing done in the class database
-- --------------------------------------------------------------------------
--use vegasdb;   -- not required for postgreSQL
