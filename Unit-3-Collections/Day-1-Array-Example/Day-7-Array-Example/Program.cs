...
class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            double[] theNumbers = new double[ARRAY_SIZE];  //define an array of 5 doubles
            ...
            // When you need to process an array from the start to the end
            // use a for loop
            // for(int i= 0; i < size-of-array; i++) - use i as the index and store in the next array element
            // {
            //      
            // }
