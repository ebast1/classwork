...
{
    // To indicate the use of an interface you code as if it were a subclass
    public class BlackJackHand : ICardHand
    {
        ...
        *********************************************************/
        ...
        private const int INITIAL_NUMBER_CARDS_IN_HAND = 2;
        private const int MAX_NUMBER_CARDS_IN_HAND = 10;
